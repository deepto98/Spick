...
- The non-activating compact HUD, bounded in-memory microphone capture, and cancellation path are working. When enabled, the HUD remains on the desktop between sessions and snaps to the left edge, right edge, or bottom-center dock.
