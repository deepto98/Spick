...
The development path enforces these rules for local and cloud transcription, target tracking, and guarded debug insertion. Release insertion remains separately gated.
...
The input-method design, development commands, and remaining release gates are documented in [docs/input-method.md](docs/input-method.md). The debug paste fallback is best-effort because paste dispatch and clipboard restoration are not atomic on macOS; release InputMethodKit work remains a separate path.
